...
Вы можете совершить Массовую отправку токенов из своего Амур аккаунта. С помощью этой функции вы можете отправить Амур или любой другой Ассет из своего аккаунта на несколько (до 100) Амур адресов.

Для этого откройте свой Амур кошелёк и во вкладке Портфель нажмите на кнопку Отправить в конце строки Ассета.
...
**Адрес, Сумма**: введите построчно Амур адреса получателей и через запятую сумму отправки;
...
**Комиссия**: в этом поле отобразиться комиссия за Массовую отправку токенов из расчета: 0,001 Амур + 0,0005 Амур x количество адресов.
...
Также вы можете импортировать файл с Амур адресами получателей и суммами.
