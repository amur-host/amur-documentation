...
Амур client позволяет хранить и переводить Ethereum внутри сети Амур. Это возможно благодаря шлюзу: Ethereum поступают на Ethereum адрес выданный пользователю в Амур client, а взамен пользователь получает ассет Ethereum в сети Амур (wETH). При выводе wETH из сети Амур пользователь получает Ethereum из расчета 1:1.
...
Откройте свой Амур кошелек и в секции Ethereum нажмите **Получить**.

![](/_assets/ethereum_transfers_01.png)

В появившемся окне вы увидите Ethereum адрес.
Используйте его в качестве адреса получателя, чтобы ввести Ethereum в свой Амур аккаунт.
...
**Внимание**: процесс ввода ETH в ваш Амур аккаунт может занять до 120 минут.

## **Как отправить Ethereum**.

Откройте ваш Амур кошелек и в Ethereum секции нажмите **Отправить**.
...
**Будьте внимательны**: комиссия Ethereum шлюза за обработку транзакции составляет 0,001 ETH, а комиссия сети Амур за проведение транзакции составляет 0,001 Амур.
...
**Внимание**: процесс вывода Ethereum из Амур аккаунта может занять до 120 минут.

## **Как перевести Bitcoin в другой Амур аккаунт**.
...
- в строку Количество сумму Ethereum, которую вы хотите отправить на Амур адрес Получателя.
