...
Амур client позволяет хранить и переводить Monero внутри сети Амур. Это возможно благодаря шлюзу: Monero поступают на Monero адрес выданный пользователю в Амур client, а взамен пользователь получает ассет Monero в сети Амур (wMonero). При выводе wMonero из сети Амур пользователь получает Monero из расчета 1:1.
...
Откройте свой Амур кошелек и в секции Monero нажмите **Получить**.

![](/_assets/monero_transfers_01.png)

В появившемся окне вы увидите Monero адрес.
Используйте его в качестве адреса получателя, чтобы ввести Monero в свой Амур аккаунт
...
**Внимание**: процесс ввода Monero в ваш Амур аккаунт может занять до 120 минут.

## **Как отправить Monero**.

Откройте ваш Амур кошелек и в Monero секции нажмите **Отправить**.
...
**Будьте внимательны**: комиссия Monero шлюза за обработку транзакции составит 0,01 Monero, а комиссия сети Амур за проведение транзакции составлит 0,001 Амур.
...
## **Как перевести Monero в другой Амур аккаунт**.
...
- в строку **Количество** сумму Monero, которую вы хотите отправить на Амур адрес Получателя.
