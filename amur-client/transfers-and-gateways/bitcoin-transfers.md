...
Амур client позволяет хранить и переводить Bitcoin внутри сети Амур. Это возможно благодаря шлюзу: Bitcoin поступают на Bitcoin адрес выданный пользователю в Амур client, а взамен пользователь получает ассет Bitcoin в сети Амур (wBTC). При выводе wBTC из сети Амур пользователь получает Bitcoin из расчета 1:1.
...
Откройте свой Амур кошелек и в секции Bitcoin нажмите **Получить**.

![](/_assets/bitcoin_transfers_01.png)

В появившемся окне вы увидите Bitcoin адрес.
Используйте его в качестве адреса получателя, чтобы ввести Bitcoin в свой Амур аккаунт
...
**Внимание**: процесс ввода BTC в ваш Амур аккаунт может занять до 120 минут.

## **Как отправить Bitcoin**.

Откройте ваш Амур кошелек и в Bitcoin секции нажмите **Отправить**.
...
**Будьте внимательны**: комиссия Bitcoin шлюза за обработку транзакции составляет 0,001 BTC, а комиссия сети Амур за проведение транзакции составляет 0,001 Амур.
...
**Внимание**: процесс вывода Bitcoin из Амур аккаунта может занять до 120 минут.
...
- в строку Количество сумму Bitcoin, которую вы хотите отправить на Амур адрес Получателя.
