...
Амур client позволяет хранить и переводить Litecoin внутри сети Амур. Это возможно благодаря шлюзу: Litecoin поступают на Litecoin адрес выданный пользователю в Амур client, а взамен пользователь получает ассет Litecoin в сети Амур (wLTC). При выводе wLTC из сети Амур пользователь получает Litecoin из расчета 1:1.
...
Откройте свой Амур кошелек и в секции Litecoin нажмите **Получить**.

![](/_assets/litecoin_transfers_01.png)

В появившемся окне вы увидите Litecoin адрес.
Используйте его в качестве адреса получателя, чтобы ввести Litecoin в свой Амур аккаунт
...
**Внимание**: процесс ввода Litecoin в ваш Амур аккаунт может занять до 120 минут.

## **Как отправить Litecoin**.

Откройте ваш Амур кошелек и в Litecoin секции нажмите **Отправить**.
...
**Будьте внимательны**: комиссия Litecoin шлюза за обработку транзакции составит 0,01 LTC, а комиссия сети Амур за проведение транзакции составлит 0,001 Амур.
...
## **Как перевести Litecoin в другой Амур аккаунт**.
...
- в строку **Количество** сумму Litecoin, которую вы хотите отправить на Амур адрес Получателя.
