...
* [Поместите свои биткоины](/waves-client/transfers-and-gateways/bitcoin-transfers.md) или любые другие [поддерживаемые монеты и токены](/waves-client/wallet-management.md) в свой кошелёк [и начните торговать на Амур DEX](/waves-client/waves-dex.md).

# 5. Установка своего собственного матчера {#Decentralizedcryptocurrencyexchange(DEX)-InstallingyourOwnMatcher}

* Пользователи могут установить их собственный матчер, установив ПО Амур и сделав доступной функциональность матчера.
