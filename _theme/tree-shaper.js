jQuery(document).ready(function () {
	...
	var addBranding = function () {
		...
		var $logo = $('<div class="sidebar-brand">' +
			'<a href="/"><img class="brand-logo" src="/_theme/brand-logo/amur-docs-logo.png"\n' +
			'     srcset="/_theme/brand-logo/amur-docs-logo@2x.png 2x,\n' +
			'             /_theme/brand-logo/amur-docs-logo@3x.png 3x"\n alt="Амур Docs"></a>' +
			'</div>');
